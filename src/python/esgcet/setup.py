...
setup(
    ...
    dependency_links = ['http://github.com/IS-ENES-Data/esgf-mapfiles/tarball/kb_dev#egg=esgmapfiles-0.6'], #TODO change to something reasonable
    install_requires = ["psycopg2>=2.0", "SQLAlchemy>=0.7.8,!=0.9.5,<=0.9.99", "lxml>=2.0", "sqlalchemy_migrate>=0.6", "requests>=1.2.0", "esgmapfiles>=0.6"],
    #setup_requires = ["psycopg2>=2.0", "SQLAlchemy>=0.7.8,!=0.9.5,<=0.9.99", "lxml>=2.0", "sqlalchemy_migrate>=0.6", "requests>=1.2.0", "lockfile>=0.11.0"],
